      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-12 lg:px-8">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link
              to="/quick-invite"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-8 py-3.5 text-base font-semibold text-amber-700 shadow-[0_16px_30px_-26px_rgba(217,119,6,0.4)] transition-all hover:border-amber-300 hover:bg-amber-100"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
              {t('landing.hero.quickInviteCta', 'Quick Invite')}
            </Link>
          </div>
