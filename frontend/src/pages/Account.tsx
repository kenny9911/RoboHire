      ...
      {topupPaymentModal !== null && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setTopupPaymentModal(null)}>
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-lg font-semibold text-gray-900 mb-1">{t('pricing.paymentModal.title', 'Select Payment Method')}</h3>
            <p className="text-sm text-gray-500 mb-6">{t('pricing.paymentModal.subtitle', 'Choose how you\'d like to complete your payment')}</p>
            <div className="space-y-3">
              <button
              ...
              <button
                ...
                className="w-full flex items-center gap-4 p-4 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors text-left"
              >
            ...
            <button onClick={() => setTopupPaymentModal(null)} className="mt-5 w-full text-sm text-gray-400 hover:text-gray-600 transition-colors">
