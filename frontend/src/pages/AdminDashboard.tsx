  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="landing-gradient-stroke flex items-center justify-between gap-3 rounded-3xl bg-white/90 p-2 shadow-[0_22px_44px_-36px_rgba(15,23,42,0.62)]">
        ...
        <a
          href="/product/admin/agent-manager"
          className="mr-2 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-violet-50 px-4 py-2 text-xs font-semibold text-violet-700 hover:bg-violet-100"
          title="Fleet-wide agent manager"
        >
