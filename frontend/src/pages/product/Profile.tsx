                      ...
                      <tr key={item.id} className="text-slate-700">
                        <td className="py-2.5 whitespace-nowrap">
                          {item.date ? (
                            <div>
                              ...
                              <div className="text-xs text-slate-400">{new Date(item.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</div>
                            </div>
                          ) : '—'}
                        </td>
                        <td className="py-2.5">
                        ...
                        <td className="py-2.5">
                          {receiptLink ? (
                            ...
                            <span className="text-xs text-slate-400 font-mono">{item.orderNo.slice(-12)}</span>
                          ) : '—'}
                        </td>
                      </tr>
                    );
